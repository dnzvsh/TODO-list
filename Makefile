...
bin/database-test: build/test/database_func_test.o build/test/main.o build/src/database_func.o
	gcc $(ERROR_OPTIONS) build/src/database_func.o build/test/main.o build/test/database_func_test.o -o bin/database-test `pkg-config --cflags --libs gtk+-3.0` -lsqlite3
...
clear:
	rm -rf build/src/*.o build/test/*.o bin/todo bin/todo-test 
